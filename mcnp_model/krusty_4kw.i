...
c ------------------------------------------------------------------------------
c
  1 1 -18.044 -1 2 301 302 303 304 305 306 307 308  imp:n=1
  2 0 -1 -2                                         imp:n=1
  3 2 -1.0 (-301 -309 310):
           (-302 -309 310):
           (-303 -309 310):
           ...
           (-307 -309 310):
           (-308 -309 310)                          imp:n=1
  4 0 1 301 302 303 304 305 306 307 308             imp:n=0
...
c ------------------------------------------------------------------------------
c
  1 rcc 0 0 0 0 0 25 11                                         $ outer radius
  2 CZ 3.988                                                    $ inner void
c 
c ------------------------------------------------------------------------------
c     Heat Pipes
c ------------------------------------------------------------------------------
c 
c 
  301 1 rcc 0 0 0 0 0 25 0.635                                  $ HP #1
  302 2 rcc 0 0 0 0 0 25 0.635                                  $ HP #2
  303 3 rcc 0 0 0 0 0 25 0.635                                  $ HP #3
  304 4 rcc 0 0 0 0 0 25 0.635                                  $ HP #4
  305 5 rcc 0 0 0 0 0 25 0.635                                  $ HP #5
  306 6 rcc 0 0 0 0 0 25 0.635                                  $ HP #6
  307 7 rcc 0 0 0 0 0 25 0.635                                  $ HP #7
  308 8 rcc 0 0 0 0 0 25 0.635                                  $ HP #8
c
  309 PZ 25
  310 PZ 0
...
c
  m4     6012.00c  0.000148583129406
         6013.00c  1.60703475654e-06
         7014.00c  0.781575372319
         7015.00c  0.00285532774824
         8016.00c  0.210235865251
         8017.00c  8.00842334828e-05
         8018.00c  0.000432033364842
        18036.00c  1.55828794033e-05
        18038.00c  2.93813883233e-06
        18040.00c  0.00465260590121
c
c ------------------------------------------------------------------------------
c
